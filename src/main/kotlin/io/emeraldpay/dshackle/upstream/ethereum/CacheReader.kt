...
class CacheReader(
    ...
    class BlockByHash(private val caches: Caches) : DshackleRpcReader {
    ...
    class TxByHash(private val caches: Caches) : DshackleRpcReader {
    ...
    class ReceiptByHash(private val caches: Caches) : DshackleRpcReader {
